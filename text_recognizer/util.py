"""Utility function for text-recognizer module."""
...
def read_image_pil(image_url: Union[Path, str], grayscale=False)->Image:
    with smart_open.open(image_url, "rb") as image_file:
        return read_image_pil_file(image_file, grayscale)

def read_image_pil_file(image_file: Union[Path, str], grayscale= False) -> Image:
